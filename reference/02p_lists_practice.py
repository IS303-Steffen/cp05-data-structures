...
# 1. PRACTICE PROBLEM: FAVORITE FOODS LIST
# Objective: Create a list of your favorite foods and manipulate it
# using list methods.

# Tasks:
#     - Create a list named favorite_foods and fill it with at least
...
#     - Use .pop() to remove the last food in your list and print the name
#       of the food that was removed.
#     - Check if "Pizza" is in your list. If it is, print
#       "Pizza is one of my favorites too!"
#     - Print out a range of foods from your list,
#       for example, the 2nd to the 4th foods.
